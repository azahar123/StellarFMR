 ...
 */
public class CameraActivitySales extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback, Camera.ShutterCallback {
    Camera camera;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((Config.imageInternetCount+1)+Config.SalesInfoImages.size()) > Integer.parseInt(Config.userDetails.get(15))){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(CameraActivitySales.this).create();
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Config.SalesInfoImages.remove(Config.SalesInfoImages.size() - 1);
                    camera.startPreview();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void cameraView() {
        ...
        jpegCallback = new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                camera.stopPreview();
                String timeStamp = "stellar" + Config.SalesInfoImages.size();
                ...
                try {
                    ...
                    Config.SalesInfoImages.add(output_file_name);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            setCameraDisplayOrientation(CameraActivitySales.this, Camera.CameraInfo.CAMERA_FACING_BACK, camera);
