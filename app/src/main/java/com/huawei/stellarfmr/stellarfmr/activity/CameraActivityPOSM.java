 ...
 */
public class CameraActivityPOSM extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback, Camera.ShutterCallback
{
    Camera camera;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((Config.posmImageCount+1)+Config.posmImages.size()) > Integer.parseInt(Config.userDetails.get(15))){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(CameraActivityPOSM.this).create();
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Config.posmImages.remove(Config.posmImages.size()-1);
                    camera.startPreview();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void cameraView() {
        ...
        jpegCallback = new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                camera.stopPreview();
                String timeStamp = "stellar"+ Config.posmImages.size();
                ...
                try {
                    ...
                    Config.posmImages.add(output_file_name);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            setCameraDisplayOrientation(CameraActivityPOSM.this, Camera.CameraInfo.CAMERA_FACING_BACK, camera);
