...
/**
 * Created by ${Azahar} on 12/26/2015.
 */
public class CameraActivityCompetitorInfo extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback, Camera.ShutterCallback
{
    Camera camera;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((Config.imageInternetCount+1)+Config.competitorinfoImages.size()) > Integer.parseInt(Config.userDetails.get(15))){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(CameraActivityCompetitorInfo.this).create();
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Config.competitorinfoImages.remove(Config.competitorinfoImages.size()-1);
                    camera.startPreview();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void cameraView() {
        ...
        jpegCallback = new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                camera.stopPreview();
                String timeStamp = "stellar"+ Config.competitorinfoImages.size();
                ...
                try {
                    ...
                    Config.competitorinfoImages.add(output_file_name);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            setCameraDisplayOrientation(CameraActivityCompetitorInfo.this, Camera.CameraInfo.CAMERA_FACING_BACK, camera);
