 ...
 */
public class CameraActivityShelf extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback, Camera.ShutterCallback
{
    Camera camera;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((Config.imageInternetCount+1)+Config.shelfInfoImages.size()) > Integer.parseInt(Config.userDetails.get(15))){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(CameraActivityShelf.this).create();
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Config.shelfInfoImages.remove(Config.shelfInfoImages.size()-1);
                    camera.startPreview();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void cameraView() {
        ...
        jpegCallback = new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                camera.stopPreview();
                String timeStamp = "stellar"+ Config.shelfInfoImages.size();
                ...
                try {
                    ...
                    Config.shelfInfoImages.add(output_file_name);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            setCameraDisplayOrientation(CameraActivityShelf.this, Camera.CameraInfo.CAMERA_FACING_BACK, camera);
