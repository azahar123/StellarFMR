 ...
 */
public class CameraActivityBranding extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback, Camera.ShutterCallback
{
    Camera camera;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (((Config.brandingImageCount+1)+Config.brandingImages.size()) > Integer.parseInt(Config.userDetails.get(15))){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(CameraActivityBranding.this).create();
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Config.brandingImages.remove(Config.brandingImages.size()-1);
                    camera.startPreview();
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void cameraView() {
        ...
        jpegCallback = new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                camera.stopPreview();
                String timeStamp = "stellar"+ Config.brandingImages.size();
                ...
                try {
                    ...
                    Config.brandingImages.add(output_file_name);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            setCameraDisplayOrientation(CameraActivityBranding.this, Camera.CameraInfo.CAMERA_FACING_BACK, camera);
